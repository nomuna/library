...
describe('Client e2e test', () => {
  ...
  it('should load Clients', async () => {
    ...
    expect(await clientComponentsPage.getTitle()).to.eq('libraryApp.client.home.title');
  });
  ...
  it('should load create Client page', async () => {
    ...
    expect(await clientUpdatePage.getPageTitle()).to.eq('libraryApp.client.home.createOrEditLabel');
  ...
  it('should delete last Client', async () => {
    ...
    expect(await clientDeleteDialog.getDialogTitle()).to.eq('libraryApp.client.delete.question');
