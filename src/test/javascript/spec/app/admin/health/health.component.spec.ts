...
import { LbrHealthCheckComponent } from 'app/admin/health/health.component';
import { LbrHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('LbrHealthCheckComponent', () => {
    let comp: LbrHealthCheckComponent;
    let fixture: ComponentFixture<LbrHealthCheckComponent>;
    let service: LbrHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [LibraryTestModule],
        declarations: [LbrHealthCheckComponent]
      })
        .overrideTemplate(LbrHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(LbrHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(LbrHealthService);
    });
