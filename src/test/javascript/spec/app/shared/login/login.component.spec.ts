...
import { LbrLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: LbrLoginModalComponent;
    let fixture: ComponentFixture<LbrLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [LbrLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(LbrLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(LbrLoginModalComponent);
