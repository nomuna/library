package com.sgaraba.library.config.timezone;

import com.sgaraba.library.LibraryApp;
import com.sgaraba.library.repository.timezone.DateTimeWrapper;
import com.sgaraba.library.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM lbr_date_time_wrapper where id=%d", fieldName, id);
    }
