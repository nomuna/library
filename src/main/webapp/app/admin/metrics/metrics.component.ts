...
import { LbrMetricsService } from './metrics.service';

@Component({
  selector: 'lbr-metrics',
  templateUrl: './metrics.component.html'
})
export class LbrMetricsMonitoringComponent implements OnInit {
  metrics: any = {};
  threadData: any = {};
  updatingMetrics = true;
  JCACHE_KEY: string;

  constructor(private metricsService: LbrMetricsService) {
