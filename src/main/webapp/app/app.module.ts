...
import { LbrMainComponent } from './layouts/main/main.component';
...
@NgModule({
  ...
  declarations: [LbrMainComponent, NavbarComponent, ErrorComponent, PageRibbonComponent, ActiveMenuDirective, FooterComponent],
  bootstrap: [LbrMainComponent]
})
